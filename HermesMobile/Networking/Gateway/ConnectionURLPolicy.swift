//
//  ConnectionURLPolicy.swift
//  HermesMobile
//
//  URL/origin validation and HTTP→WS scheme conversion for the Hermes Agent
//  gateway transport.
//
//  Adapted from hermes-conduit (MIT License),
//  Conduit/Services/ConnectionURLPolicy.swift for the Hermex fork's native
//  dashboard transport.
//
